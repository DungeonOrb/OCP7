...
export default function EditTaskModal({ isOpen, onClose, onUpdated, project, task }) {
  ...
  useEffect(() => {
    ...
    setDueDate(formatDateForDateInput(task.dueDate));
    setStatus(task.status || "TODO");
    setPriority(task.priority || "MEDIUM");
    setSelectedAssignees((task.assignees || []).map((assignee) => assignee.user));
    setAssigneeQuery("");
    setAssigneeResults([]);
    setError("");
  }, [task, isOpen]);
  ...
  return (
    <div className={styles.overlay}>
      <div className={styles.modal}>
        ...
        <h2 className={styles.title}>Modifier la tâche</h2>
            ...
            <div className={styles.statusRow}>
              <button
                ...
                className={`${styles.statusButton} ${
                  status === "TODO" ? styles.todoActive : styles.todo
                }`}
              ...
              <button
                type="button"
                className={`${styles.statusButton} ${
                  status === "DONE" ? styles.doneActive : styles.done
                }`}
